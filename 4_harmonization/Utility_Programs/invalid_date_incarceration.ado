/*==============================================================================
Invalid Incarceration Date
==========================
Utility program for logical validation of incarceration date variables. Dates set 
...
==============================================================================*/
#delimit;
program define invalid_date_incarceration;
	local data="`1'";
	...
	foreach stub in inc_entry inc_exit {;
		...
		if r(N)>0 {;
			...
			if r(N)>0{;
				if `j'==1{;
					file open myfile using "${codedir}\4_harmonization\1_prepared\\`data'\\invalid_date_inc.txt", write replace;
					file write myfile "variable,count_invalid"_n;
					file close myfile;
				};
				file open myfile using "${codedir}\4_harmonization\1_prepared\\`data'\\invalid_date_inc.txt", write append;
