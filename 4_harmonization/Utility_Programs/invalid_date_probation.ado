/*==============================================================================
Invalid Probation Date
======================
Utility program for logical validation of probation date variables. Dates set 
...
==============================================================================*/
#delimit;
program define invalid_date_probation;
#delimit;
	local data="`1'";
	...
	foreach stub in pro_bgn pro_end {;
		...
		if r(N)>0 {;
			...
			if r(N)>0{;
				if `j'==1{;
					file open myfile using "${codedir}\4_harmonization\1_prepared\\`data'\\invalid_date_pro.txt", write replace;
					file write myfile "variable,count_invalid"_n;
					file close myfile;
				};
				file open myfile using "${codedir}\4_harmonization\1_prepared\\`data'\\invalid_date_pro.txt", write append;
